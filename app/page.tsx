...
export default function MyBibleAdventure() {
  ...
  const storySlideContent = (
    <div className="w-full max-w-2xl mx-auto">
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-8 max-sm:border-4 border-yellow-100 p-8 max-sm:p-4">
        ...
        {/* Story text */}
        <p className="text-center text-xl max-sm:text-base text-gray-800 mb-8 max-sm:mb-4 leading-relaxed font-semibold">
          {formattedText}
        </p>

        {/* Story progress */}
        <div className="flex justify-center gap-2 max-sm:gap-1 mb-8 max-sm:mb-4">
          {/* FIX 1: Added optional chaining here */}
          {currentStoryData?.slides?.map((_, idx) => (
            <div
              key={idx}
              className={`h-3 max-sm:h-2 rounded-full transition-all ${
        ...
        <div className="flex justify-center items-center gap-4 max-sm:gap-2 mb-6 max-sm:mb-4 p-3 max-sm:p-2 bg-purple-50 rounded-2xl border-2 border-purple-100">
          <button
            onClick={toggleMusic}
            className={`flex items-center gap-2 px-4 py-2 max-sm:px-3 max-sm:py-1 max-sm:text-xs rounded-full font-bold text-sm transition-all ${
              isMusicPlaying
          ...
          <select
            ...
            className="px-3 py-2 max-sm:px-2 max-sm:py-1 text-sm max-sm:text-xs rounded-xl border-2 border-purple-200 bg-white font-semibold text-gray-700 focus:outline-none"
          >
        ...
        {/* Navigation buttons */}
        <div className="flex justify-between items-center max-sm:flex-col gap-4 max-sm:gap-2 mb-6 max-sm:mb-4">
          <button
            onClick={() => setCurrentSlide(Math.max(0, currentSlide - 1))}
            disabled={currentSlide === 0}
            className="flex items-center gap-2 px-6 py-3 max-sm:px-4 max-sm:py-2 max-sm:w-full max-sm:text-base bg-blue-500 text-white rounded-full hover:bg-blue-600 disabled:bg-gray-300 transition-colors font-bold text-lg"
          >
            <ChevronLeft size={24} />
            Back
          </button>
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 max-sm:px-4 max-sm:py-2 max-sm:w-full max-sm:text-base bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors font-bold text-lg animate-pulse"
          >
            <Volume2 size={24} />
        ...
        <button
          ...
          className="w-full mt-8 max-sm:mt-4 px-6 py-4 max-sm:px-4 max-sm:py-3 bg-purple-500 text-white rounded-full hover:bg-purple-600 transition-colors font-bold text-lg max-sm:text-base"
        >
          Back to Menu
        </button>
      </div>
  ...
  const configForm = (
    <div className="w-full max-w-2xl mx-auto">
      <div className="bg-gradient-to-b from-purple-100 to-pink-100 rounded-3xl shadow-2xl p-8 md:p-12 max-sm:p-4 max-sm:border-4 border-8 border-pink-200">
        <h1 className="text-5xl md:text-6xl max-sm:text-3xl font-bold text-center mb-2 text-purple-800">
          🙏 My Bible Adventure
        </h1>
        <p className="text-center text-lg max-sm:text-sm text-purple-700 mb-8 max-sm:mb-4">
        ...
        <div className="space-y-6">
          {/* Child's Name */}
          <div>
            <label className="block text-xl max-sm:text-base font-bold text-gray-800 mb-2">
              👤 Child's Name
            </label>
            <input
              type="text"
              ...
              className="w-full px-6 py-4 max-sm:px-4 max-sm:py-3 text-lg max-sm:text-sm rounded-xl border-4 border-purple-300 bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:border-purple-600 font-semibold"
            />
          </div>

          {/* Pronouns */}
          <div>
            <label className="block text-xl max-sm:text-base font-bold text-gray-800 mb-3">
              💬 Pronoun
            </label>
            <div className="flex gap-6 max-sm:gap-4">
              {[
                ...
                <label
                  key={option.value}
                  className="flex items-center gap-3 max-sm:gap-2 cursor-pointer"
                >
                  <input
                    type="radio"
                    value={option.value}
                  ...
                  />
                  <span className="text-lg max-sm:text-sm font-semibold text-gray-800">
                    {option.label}
                  </span>
                </label>
              ))}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-6 py-4 max-sm:px-4 max-sm:py-3 text-lg max-sm:text-sm rounded-xl border-4 border-purple-300 bg-white text-gray-800 focus:outline-none focus:border-purple-600 font-semibold"
            >
          ...
          <button
            ...
            className="w-full px-8 py-5 max-sm:px-4 max-sm:py-3 mt-8 max-sm:mt-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white text-2xl max-sm:text-lg font-bold rounded-2xl hover:shadow-xl disabled:bg-gray-400 disabled:cursor-not-allowed transition-all hover:scale-105"
          >
            📖 Open My Bible Story
          </button>
        </div>
    ...
    >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 max-sm:mb-6">
          <div className="text-7xl mb-4 max-sm:text-2xl max-sm:mb-2 animate-float">✨</div>
          <h1 className="text-4xl md:text-5xl max-sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 via-purple-600 to-blue-600 mb-2">
            My Bible Adventure
          </h1>
        ...
        {/* Footer */}
        <div className="text-center mt-12 max-sm:mt-6 text-gray-600">
          <p className="text-sm">
